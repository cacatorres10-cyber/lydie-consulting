...
const fr: Copy = {
  ...
  hero: {
    ...
    headline: 'Créer des ponts entre les services, les territoires et les personnes.',
    headlineGold: 'les services, les territoires et les personnes',
    available: 'Disponible pour de nouvelles missions',
    sub: 'Je propose des accompagnements sur mesure en voyages, conseil migratoire et consulaire, événementiel, formation, patrimoine, ressources humaines, bien-être, diplomatie et connexion de services.',
    ctaPrimary: 'Demander ce service',
  ...
  about: {
    eyebrow: 'À propos',
    title: 'Une expertise au service des personnes et des institutions',
    quote: "Chaque projet est une rencontre entre des cultures, des institutions et des besoins concrets.",
    p1: "Depuis 2017, je forme les élues locales au sein de l'IEPP à Paris et j'accompagne des organisations publiques et privées en France et à l'international. Mon parcours mêle l'action publique, la formation, l'événementiel, le conseil et la mise en réseau de services à forte valeur humaine.",
    p2: "Formée à l'Université des Antilles et à l'Université Bordeaux 2, certifiée formatrice de formateurs (2011) et formée à l'ICOPER en diplomatie, relations extérieures, communication politique, gestion de crise et porte-parolat institutionnel (2026), je porte une attention particulière à la coopération latino-américaine, caribéenne et internationale.",
    p3: "De la stratégie à la mise en œuvre, chaque mission est construite sur mesure: analyse, plan d'action, accompagnement et transmission, avec un angle très concret pour les particuliers comme pour les professionnels.",
  ...
  services: {
    eyebrow: 'Services',
    title: 'Agencia de viajes, formación, eventos, patrimonio y asesoría migratoria',
    sub: 'Chaque espace peut devenir un point d’entrée vers un service précis.',
    prevLabel: 'Service précédent',
    nextLabel: 'Service suivant',
    items: [
      { name: 'Assistance migratoire et consulaire', category: 'Conseil stratégique', tagline: 'Accompagnement pour les démarches, visas, résidence et questions consulaires.' },
      { name: 'Voyages, tours et réservations', category: 'Voyages', tagline: 'Voyages, circuits, hôtels, voitures, logements, transports terrestres, croisières et avions.' },
      { name: 'Particuliers et professionnels', category: 'Mobilité', tagline: 'Organisation de voyages sur mesure pour les particuliers comme pour les professionnels.' },
      { name: 'Événementiel privé et institutionnel', category: 'Événementiel', tagline: 'Vocalisation institutionnelle, mariages, 15 ans, anniversaires, fêtes et événements publics ou privés.' },
      { name: 'Formation de formateurs et pédagogie', category: 'Formation', tagline: 'Ingénierie pédagogique, formation de formateurs, formation d’élus, préparation de concours publics et formation en langues.' },
      { name: 'Gestion de projets et élites', category: 'Formation', tagline: 'Conception de programmes, accompagnement de personnes élues et préparation aux concours publics.' },
      { name: 'Patrimoine et immobilier', category: 'Patrimoine', tagline: 'Gestion de patrimoine, microfinance, rachat de prêts immobiliers ou personnels, assurances et transactions immobilières.' },
      { name: 'Diplomatie et coopération', category: 'Relations institutionnelles', tagline: 'Représentation, médiation, relations institutionnelles, porte-parolat et gestion de crise.' },
      { name: 'Bien-être', category: 'Santé & équilibre', tagline: 'Centre sportif, naturopathie, conseils, programmes et nutrition saine.' },
      { name: 'Ressources humaines', category: 'Recrutement', tagline: 'Connexion de fournisseurs et services, recrutement de profils qualifiés, mise en relation de prestataires.' },
      { name: 'Connexion de fournisseurs et services', category: 'Réseau', tagline: 'Consulter un coach sportif, un naturopathe, un courtier en assurances, un expert en finances, un gestionnaire de patrimoine, un agent de voyages ou un formateur.' },
      { name: 'Livres en PDF', category: 'Éducation', tagline: 'Accès à la vente et au téléchargement de livres en format PDF.' },
    ],
  },
  career: {
    eyebrow: 'Parcours',
    title: 'Expérience professionnelle',
    sub: 'Depuis 2017, je forme des élues locales au sein de l’IEPP de Paris et j’accompagne des projets de formation, de coopération, de tourisme et d’organisation.',
    items: [
      {
  ...
  forum: {
    ...
    intro:
      'Un espace à part, indépendant de tout autre projet, pensé comme une page dédiée à la collecte de fonds au nom d’une structure associative, fondation ou autre initiative citoyenne.',
    tabs: ['Vision', 'Le Forum Amérique Latine & Caraïbe', 'Édition pilote : Guadeloupe', 'Académie Leadership'],
    donateLabel: 'Nous contacter',
    donateMessage: 'Bonjour Lydie, je souhaite demander un service spécifique ou obtenir plus d’informations.',
    vision: {
...
const es: Copy = {
  ...
  hero: {
    ...
    name: 'Lydie Monthouel Lebron de Guarinos',
    headline: 'Conectar servicios, territorios y personas con soluciones concretas.',
    headlineGold: 'servicios, territorios y personas',
    available: 'Disponible para nuevas misiones',
    sub: 'Acompaño a instituciones, empresas y particulares en viajes, asesoría migratoria y consular, eventos, formación, patrimonio, recursos humanos, bienestar, diplomacia y conexión de servicios.',
    ctaPrimary: 'Pedir este servicio',
    ctaSecondary: 'LinkedIn',
    stats: [
  ...
  services: {
    eyebrow: 'Servicios',
    title: 'Viajes, formación, patrimonio, bienestar y asesoría migratoria',
    sub: 'Cada espacio puede convertirse en una puerta para pedir un servicio concreto.',
    prevLabel: 'Servicio anterior',
    nextLabel: 'Servicio siguiente',
    items: [
      { name: 'Asesoría migratoria y consular', category: 'Movilidad', tagline: 'Acompañamiento para trámites, visados, residencia y asuntos consulares.' },
      { name: 'Viajes, tours y reservas', category: 'Viajes', tagline: 'Vuelos, hoteles, carros, alojamiento, cruceros, trenes, viajes terrestres y circuitos.' },
      { name: 'Particulares y profesionales', category: 'Movilidad', tagline: 'Organización de viajes a medida para particulares y profesionales.' },
      { name: 'Eventos privados e institucionales', category: 'Eventos', tagline: 'Vocería institucional, bodas, 15 años, aniversarios, fiestas y eventos públicos o privados.' },
      { name: 'Formación de formadores y pedagogía', category: 'Formación', tagline: 'Ingeniería pedagógica, formación de formadores, formación de electos y preparación de concursos públicos.' },
      { name: 'Gestión de proyectos y electos', category: 'Formación', tagline: 'Diseño de programas, acompañamiento de personas electas y preparación para concursos públicos.' },
      { name: 'Patrimonio e inmobiliario', category: 'Patrimonio', tagline: 'Gestión de patrimonio, microfinanzas, reestructuración de préstamos, seguros y bienes raíces.' },
      { name: 'Diplomacia y cooperación', category: 'Relaciones institucionales', tagline: 'Representación, mediación, relaciones institucionales, vocería y gestión de crisis.' },
      { name: 'Bienestar', category: 'Salud y equilibrio', tagline: 'Centro deportivo, naturopatía, formación, consejos y nutrición saludable.' },
      { name: 'Recursos humanos', category: 'Reclutamiento', tagline: 'Conexión de proveedores y servicios, y reclutamiento de perfiles calificados.' },
      { name: 'Conexión de proveedores y servicios', category: 'Red de apoyo', tagline: 'Consultar un coach deportivo, un naturopata, un corredor de seguros, un experto financiero o un agente de viajes.' },
      { name: 'Libros en PDF', category: 'Educación', tagline: 'Acceso a la compra y descarga de libros en formato PDF.' },
    ],
  },
  career: {
    eyebrow: 'Trayectoria',
    title: 'Experiencia profesional',
    sub: 'Desde 2017 formo a electas locales en el IEPP de París y acompaño proyectos de formación, turismo y cooperación.',
    items: [
      {
  ...
  forum: {
    ...
    intro:
      'Una página independiente, apartada de los demás servicios, pensada como espacio de recaudación de fondos a nombre de una estructura asociativa, fundación u otra iniciativa ciudadana.',
    tabs: ['Visión', 'El Foro América Latina y Caribe', 'Edición piloto: Guadalupe', 'Academia de Liderazgo'],
    donateLabel: 'Contactar',
    donateMessage: 'Hola Lydie, deseo pedir un servicio específico o recibir más información.',
    vision: {
