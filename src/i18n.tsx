...
const fr: Copy = {
  ...
  hero: {
    ...
    sub: 'Je propose des accompagnements sur mesure en voyages, conseil migratoire et consulaire, événementiel, formation, patrimoine, ressources humaines, bien-être et diplomatie.',
  ...
  services: {
    ...
    items: [
      ...
      { name: 'Formation de formateurs et pédagogie', category: 'Formation', tagline: 'Ingénierie pédagogique, formation de formateurs, préparation de concours publics et formation en langues.' },
      { name: 'Gestion de projets et élites', category: 'Formation', tagline: 'Conception de programmes, accompagnement d’élus et préparation aux concours publics.' },
      { name: 'Patrimoine et immobilier', category: 'Patrimoine', tagline: 'Gestion de patrimoine, microfinance, rachat de prêts, assurances et transactions immobilières.' },
      { name: 'Diplomatie et coopération', category: 'Relations institutionnelles', tagline: 'Représentation, médiation, relations institutionnelles et gestion de crise.' },
      { name: 'Bien-être', category: 'Santé & équilibre', tagline: 'Centre sportif, naturopathie, conseils, programmes et nutrition saine.' },
      { name: 'Ressources humaines', category: 'Recrutement', tagline: 'Connexion de fournisseurs et services, recrutement de profils qualifiés.' },
      { name: 'Connexion de fournisseurs et services', category: 'Réseau', tagline: 'Consulter un coach sportif, un naturopathe, un courtier en assurances, un expert en finances ou un agent de voyages.' },
  ...
  career: {
    ...
    sub: 'Depuis 2017, je forme des élues locales et j’accompagne des projets de formation, de coopération et d’organisation.',
    items: [
      {
  ...
  forum: {
    ...
    intro:
      'Un espace de réflexion et d’action qui peut se déconnecter de tout projet existant pour devenir un lieu de collecte de fonds au nom d’une structure associative ou fondation.',
