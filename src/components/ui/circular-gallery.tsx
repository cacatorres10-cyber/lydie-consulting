          ...
          {items.map((item, i) => {
            ...
            return (
              <div
                ...
                className="absolute w-[150px] h-[210px] -ml-[75px] -mt-[105px] sm:w-[200px] sm:h-[270px] sm:-ml-[100px] sm:-mt-[135px] md:w-[250px] md:h-[330px] md:-ml-[125px] md:-mt-[165px] lg:w-[300px] lg:h-[400px] lg:-ml-[150px] lg:-mt-[200px]"
                style={{
